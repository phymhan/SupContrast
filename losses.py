...
class SupConLoss(nn.Module):
    ...
    def forward(self, features, neg_features=None, labels=None, mask=None):
        ...
        if labels is not None and mask is not None:
            ...
            # creates a mask of positives with respect to each element in the batch (even including oneself)
        ...
        if neg_features is not None:
            ...
            contrast_feature = torch.cat([contrast_feature.unsqueeze(0).repeat(neg_features.shape[0], 1, 1), neg_features], dim=1)
