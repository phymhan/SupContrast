...
parser.add_argument('--test-data', type=Path, metavar='TESTDIR', default="/anonymous/",
...
parser.add_argument('--learning-rate', default=5.0, type=float, metavar='LR',
                    help='base learning rate')
parser.add_argument('--weight-decay', default=0.0, type=float, metavar='W',
                    help='weight decay')
...
parser.add_argument('--checkpoint-path', default='/anonymous/', type=Path,
                    metavar='DIR', help='path to checkpoint file for encoder')                    
...
class Trainer(object):
    ...
    def __call__(self):
        import linear_eval_helper
        self._setup_gpu_args()
        linear_eval_helper.main_worker(self.args)
